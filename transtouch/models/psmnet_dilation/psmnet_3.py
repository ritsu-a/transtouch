...
class PSMNetDilation(nn.Module):
    def __init__(
        self, num_ir: int, min_disp: float, max_disp: float, num_disp: int, set_zero: bool, dilation: int, use_off: bool
    ):
    ...
    def forward(self, data_batch):
        ...
        if self.training:
            ...
            import warnings
            warnings.warn("REMEMBER TO CHANGE VARIACE BASED CONFIDENCE BACK")
