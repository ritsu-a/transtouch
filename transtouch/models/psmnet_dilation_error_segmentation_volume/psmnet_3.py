...
from transtouch.models.psmnet_dilation_error_segmentation.resnet import ResNet18_OS16, ResNet34_OS16, ResNet50_OS16, ResNet101_OS16, ResNet152_OS16, ResNet18_OS8, ResNet34_OS8
from transtouch.models.psmnet_dilation_error_segmentation.aspp import ASPP, ASPP_Bottleneck
...
class PSMNetDilationErrorSegmentationVolume(nn.Module):
    def __init__(
        self, num_ir: int, min_disp: float, max_disp: float, num_disp: int, set_zero: bool, dilation: int, use_off: bool, alpha: float
    ):
        super(PSMNetDilationErrorSegmentationVolume, self).__init__()
        self.num_ir = num_ir
    ...
    def forward(self, data_batch):
        ...
        error_feature1 = cost1.clone().detach().squeeze(1)
